...
int main(void)
{
	// from [0.25, 0.25] dir [0.9, 1.0]
	{
        ...
        std::vector<LineSuperCover::Index2> results = cover.rayCover(0.25f, 0.25f, 0.99f, 1.f);
	...
	{
		LineSuperCover cover(2, 2);
        std::vector<LineSuperCover::Index2> results = cover.rayCover(0.75f, 0.25f, 0.99f, 1.f);
	...
	{
		LineSuperCover cover(2, 2);
        std::vector<LineSuperCover::Index2> results = cover.rayCover(0.25f, 0.75f, 0.99f, 1.f);
		LineSuperCover::Index2 correct_array[] = { LineSuperCover::Index2(0,0), LineSuperCover::Index2(0,1), LineSuperCover::Index2(1,1) };
		std::vector<LineSuperCover::Index2> correct(correct_array, correct_array + sizeof(correct_array) / sizeof(LineSuperCover::Index2));
	...
	{
		LineSuperCover cover(2, 2);
        std::vector<LineSuperCover::Index2> results = cover.rayCover(0.75f, 0.75f, 0.99f, 1.f);
		LineSuperCover::Index2 correct_array[] = { LineSuperCover::Index2(0,0), LineSuperCover::Index2(0,1), LineSuperCover::Index2(1,1) };
		std::vector<LineSuperCover::Index2> correct(correct_array, correct_array + sizeof(correct_array) / sizeof(LineSuperCover::Index2));
	...
	{
		LineSuperCover cover(2, 2);
        std::vector<LineSuperCover::Index2> results = cover.rayCover(1.5f, 0.5f, -0.9f, 1.f);
	...
	{
		LineSuperCover cover(2, 2);
        std::vector<LineSuperCover::Index2> results = cover.rayCover(0.5f, 1.5f, 0.9f, -1.f);
	...
	{
		LineSuperCover cover(2, 2);
        std::vector<LineSuperCover::Index2> results = cover.rayCover(1.5f, 1.5f, -0.9f, -1.f);
