...
int main(void)
{
	// from [0.25, 0.25] dir [1.0, 0.9]
	{
		...
		std::vector<Index2> results = cover.traverse(0.25f, 0.25f, 1.f, 0.99f);
	...
	{
		LineSuperCover cover(2, 2);
		std::vector<Index2> results = cover.traverse(0.75f, 0.25f, 1.f, 0.99f);
		Index2 correct_array[] = { Index2(0,0), Index2(1,0), Index2(1,1) };
		std::vector<Index2> correct(correct_array, correct_array + sizeof(correct_array) / sizeof(Index2));
	...
	{
		LineSuperCover cover(2, 2);
		std::vector<Index2> results = cover.traverse(0.25f, 0.75f, 1.f, 0.99f);
	...
	{
		LineSuperCover cover(2, 2);
		std::vector<Index2> results = cover.traverse(0.75f, 0.75f, 1.f, 0.99f);
		Index2 correct_array[] = { Index2(0,0), Index2(1,0), Index2(1,1) };
		std::vector<Index2> correct(correct_array, correct_array + sizeof(correct_array) / sizeof(Index2));
	...
	{
		LineSuperCover cover(2, 2);
		std::vector<Index2> results = cover.traverse(1.5f, 0.5f, -1.f, 0.9f);
		Index2 correct_array[] = { Index2(1,0), Index2(0,0), Index2(0,1) };
		std::vector<Index2> correct(correct_array, correct_array + sizeof(correct_array) / sizeof(Index2));
	...
	{
		LineSuperCover cover(2, 2);
		std::vector<Index2> results = cover.traverse(0.5f, 1.5f, 1.f, -0.9f);
		Index2 correct_array[] = { Index2(0,1), Index2(1,1), Index2(1,0) };
		std::vector<Index2> correct(correct_array, correct_array + sizeof(correct_array) / sizeof(Index2));
	...
	{
		LineSuperCover cover(2, 2);
		std::vector<Index2> results = cover.traverse(1.5f, 1.5f, -1.f, -0.9f);
		Index2 correct_array[] = { Index2(1,1), Index2(0,1), Index2(0,0) };
		std::vector<Index2> correct(correct_array, correct_array + sizeof(correct_array) / sizeof(Index2));
