...
int main(void)
{
	// from [0.25, 0.25] dir [1.0, 0.9]
	{
		...
		std::vector<LineSuperCover::Index2> results = cover.traverse(0.25f, 0.25f, 1.f, 0.99f);
	...
	{
		LineSuperCover cover(2, 2);
		std::vector<LineSuperCover::Index2> results = cover.traverse(0.75f, 0.25f, 1.f, 0.99f);
		LineSuperCover::Index2 correct_array[] = { LineSuperCover::Index2(0,0), LineSuperCover::Index2(1,0), LineSuperCover::Index2(1,1) };
		std::vector<LineSuperCover::Index2> correct(correct_array, correct_array + sizeof(correct_array) / sizeof(LineSuperCover::Index2));
	...
	{
		LineSuperCover cover(2, 2);
		std::vector<LineSuperCover::Index2> results = cover.traverse(0.25f, 0.75f, 1.f, 0.99f);
	...
	{
		LineSuperCover cover(2, 2);
		std::vector<LineSuperCover::Index2> results = cover.traverse(0.75f, 0.75f, 1.f, 0.99f);
		LineSuperCover::Index2 correct_array[] = { LineSuperCover::Index2(0,0), LineSuperCover::Index2(1,0), LineSuperCover::Index2(1,1) };
		std::vector<LineSuperCover::Index2> correct(correct_array, correct_array + sizeof(correct_array) / sizeof(LineSuperCover::Index2));
	...
	{
		LineSuperCover cover(2, 2);
		std::vector<LineSuperCover::Index2> results = cover.traverse(1.5f, 0.5f, -1.f, 0.9f);
	...
	{
		LineSuperCover cover(2, 2);
		std::vector<LineSuperCover::Index2> results = cover.traverse(0.5f, 1.5f, 1.f, -0.9f);
	...
	{
		LineSuperCover cover(2, 2);
		std::vector<LineSuperCover::Index2> results = cover.traverse(1.5f, 1.5f, -1.f, -0.9f);
